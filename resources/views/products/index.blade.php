<x-guest-layout>
    ...
    {{-- Bagian 1: Header Page (Product List Page) --}}
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg text-left mb-10 border border-gray-200">
                <div class="flex flex-col md:flex-row items-center">
                    {{-- Gambar Placeholder untuk Koleksi --}}
                    {{--  --}}
    ...
    {{-- Bagian 2: Filter dan Produk Grid --}}
        ...
        <div class="flex flex-col lg:flex-row gap-10">
            ...
            <div class="w-full lg:w-3/4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                    {{-- Kita akan menggunakan Component ProductCard yang sudah dibuat sebelumnya --}}
                    @forelse ($products as $product)
                        {{-- Menggunakan ProductCard dengan sedikit penyesuaian gaya agar mirip desain baru --}}
                        <div class="group relative bg-white rounded-lg shadow-sm hover:shadow-lg transition duration-300">
                            ...
                            <div class="aspect-w-1 aspect-h-1 w-full overflow-hidden bg-gray-100">
                                ...
                                {{-- Ikon Aksi Cepat (Like, View, Cart) --}}
